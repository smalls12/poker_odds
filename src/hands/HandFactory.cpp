...
std::map<HandRank, std::function<Hand(int id, Cards cards, Cards validated)>> router{
    ...
    { HandRank::STRAIGHT_FLUSH_ACE_LOW, [](int id, Cards cards, Cards validated){ return StraightFlushAceLowHand(id, cards, validated); } },
    ...
    { HandRank::STRAIGHT_ACE_LOW, [](int id, Cards cards, Cards validated){ return StraightAceLowHand(id, cards, validated); } },
